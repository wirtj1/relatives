...
-- Create accounts
INSERT INTO PUBLIC.ACCOUNT (ID, PASSWORD, PERMISSION, USERNAME, PERSON_ID) VALUES (10, 'myPW', null, 'jacks_sister', 40,);
INSERT INTO PUBLIC.ACCOUNT (ID, PASSWORD, PERMISSION, USERNAME, PERSON_ID) VALUES (20, 'myPW', null, 'jacks_playmate', 80);
INSERT INTO PUBLIC.ACCOUNT (ID, PASSWORD, PERMISSION, USERNAME, PERSON_ID) VALUES (30, 'myPW', null, 'superprof', 40);

-- Create Pinnboard entry
INSERT INTO PUBLIC.PINBOARDENTRY (ID, CREATIONDATE, MESSAGE, TITLE, TYPE, AUTHOR_ID) VALUES (10, '2017-05-20 19:46:47.372000000', 'Our neightbour disappeard!', 'Neighbour', 3, 40);
INSERT INTO PUBLIC.PINBOARDENTRY (ID, CREATIONDATE, MESSAGE, TITLE, TYPE, AUTHOR_ID) VALUES (20, '2017-05-21 15:02:32.372000000', 'John was alone yesterday', 'Alone',2, 10);
INSERT INTO PUBLIC.PINBOARDENTRY (ID, CREATIONDATE, MESSAGE, TITLE, TYPE, AUTHOR_ID) VALUES (30, '2017-05-21 19:46:47.372000000', 'It seams John is not cured', 'Not cured',1, 30);
...
INSERT INTO PUBLIC.PATIENT_RELATIVE (PATIENT_ID, RELATIVES_ID) VALUES (100, 80);
INSERT INTO PUBLIC.PATIENT_RELATIVE (PATIENT_ID, RELATIVES_ID) VALUES (10, 40);
